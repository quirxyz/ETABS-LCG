...
Then copy the formatted load combinations to ETABS Interactive Database. 

Note: Load Pattern names in ETABS and in the generator must be consistent to prevent any errors upon input in Interactive Database. 
